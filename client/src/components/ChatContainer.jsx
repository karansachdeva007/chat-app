...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className="w-full overflow-scroll relative background-blur-lg">
      {/* -header----------- */}
        ...
        {messages.map((msg, index) => (
          ...
          >
            {msg.image ? (
              ...
              <p
                className={`p-2 max-w-[200px] md:text-sm font-light rounded-lg mb-8 brak-all bg-violet-500/30 text-white ${
